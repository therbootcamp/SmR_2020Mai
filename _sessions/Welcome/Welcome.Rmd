...
You will be working with many <high>fun datasets</high> in the practicals

1 - Predicting baseball player salaries

2 - Analysing the results from a real clinical trial comparing the effectiveness of 4 different drugs on the health of AIDS patients.

3 - Analysing the "Tomatometer" movie ratings of raters who were either sober or under the influence of alcohol

4 - Predicting the weekly price of avacados
...
<font style="font-size:32px"><high>Let us know, personally or via mail, if you don't want be published.</high></font>
