...
2. Using the `aov()` function, create an object called `days_arms_aov` which conducts an ANOVA comparing the number of days until a negative event (`days`) between treatment arms (`arms`).
...
4. Did older patients have higher CD4 T cell counts at baseline (`cd40`) compared to younger patients?
