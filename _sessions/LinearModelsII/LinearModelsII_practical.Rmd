...
1. Wie du kategorische Variablen als Prädiktoren in einer Regression verwendest und interpretierst. 
...
1. In diesem Abschnitt geht es darum des Effekt der `Farbe` (Prädiktor) des Weins, rot oder weiss, auf die `Qualität` des Weines zu prüfen. Verwende hierzu zunächst den code unten um zwei Vektoren zu erstellen, die jeweils die Qualitätswerte für weisse und rote Weine beinhalten. 
