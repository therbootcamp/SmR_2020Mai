...
7. Verwende `names(XX)`, `summary(XX)`, und `View()` um einen weiteren Überblick über die Daten zu bekommen.
...
4. Lasse dir nun die `summary()` anzeigen und inspiziere die t-Werte und Signifikanzen. Welche Prädiktoren sind signifikant?
