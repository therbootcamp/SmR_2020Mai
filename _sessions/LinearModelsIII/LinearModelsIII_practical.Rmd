...
5. Alle Effekte sind trotz des teilweise kleinen Einflusses (im Fall von `Max_Preis`), was sicherlich der grossen Stichprobe zu schulden ist. Nichtsdestotrotz, zeigt die `Residual deviance` und der ein klar niedrigeren Wert als die `Null deviance`. Was sagt dir dies? 
