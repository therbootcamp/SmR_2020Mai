...
6. Lasse dir nun die `summary()` anzeigen. Der Output ist sehr ähnlich aufgebaut zum dem von `lm()`. Lenke deine Aufmerksamkeit zunächst auf den Teil zu `Coefficients`. Welche Prädiktoren sind signifikant?
