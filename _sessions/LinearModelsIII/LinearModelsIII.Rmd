...
<ul>
  ...
  <li class="m2"><span>Ermöglicht gegenüber dem allgemeinen Linearen Modell <high>verschiene Datenmodelle und Link-Funktionen</high></span></li>
</ul>
...
$$\Large p(y = 1) = \frac{1}{1 + e^{-b_0+b_1*x}}$$
]
...
$$\large L(y_i|\mathbf{b})= {{N}\choose{k}}p_{y_i=1}^k(1-p_{y_i=1})^{1-k}$$
...
<ul>
  <li class="m1"><span>Generalisierte lineare Modelle können mit dem <high>Aikaike Informationskriterium (AIC)</high> verglichen werden.</high>.</span></li>
