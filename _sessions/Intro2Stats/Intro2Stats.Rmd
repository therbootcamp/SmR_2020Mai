...
<ul>
  ...
  <li class="m3"><span><high>Visualisierungen</high></span></li>
</ul>
...
<ul>
  ...
  <ul class=level>
    <li><span>Unterscheiden sich ein deskriptives Masse von einem <high>angenommenen Wert</high>, e.g., zum Beispiel 0.</b></span></li>
...
<ul>
  ...
  <ul class=level>
    <li><span><high>Unterscheidet</high> sich ein deskriptives Mass <high>von angenommenen Werten</high>, e.g., zum Beispiel 0.</span></li>
...
<ul>
  <li class="m1"><span>Jede statistische Inferenz begint mit <high>Annahmen über die Population</high>.</span></li>
...
<ul>
  <li class="m1"><span>Die X<sup>2</sup> Teststatistik summiert die <high>normalisierten, quadfratischen Abweichungen</high> vom der auf Basis von <mono><b>p</b></mono> erwarteten Häufigkeiten.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Testverteilungen haben Parameter, die <high>aktuelle Situation angepasst werden</high>.</span></li>
...
<h1><a href="https://therbootcamp.github.io/SmR_2020Mar/index.html">Schedule</a></h1>
