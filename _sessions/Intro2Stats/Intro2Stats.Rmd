...
<<<<<<< HEAD
If there is a 50% chance of a drug being successful, then out of 10 drugs, <high>how likely is it that exactly 5 will be successful</high>?
...
>>>>>>> 366b98c024dcd0095c0eab11b57ab62efeaeaec5
...
This evaluation is performed by calculating the likelihood of the data <high>given</high> that one of these hypotheses are true.
...
<<<<<<< HEAD
Test statistics are numbers that help you quantify how likely data is given a null hypothesis. Generally, the <high>more extreme</high> your test statistic is, the <high>more evidence</high> *against* the null hypothesis.
...
<p align = "center">
  <img src="image/pvalue_level.png" height=460px>
</p>
...
Our <high><i>p</i>-value</high>, indicating the <high>likelihood of obtaining the data if the null hypothesis is true</high>, was (only) `0.0273`.

The data are very unlikely, if the mean amount poured is really 33cl. 
=======
.pull-left5[
...
<<<<<<< HEAD
<font style="font-size:32px">The Oetlinger buvette is pouring less than 33cl!&#128551;&#x1F620;&#x1F92C;</font> 
