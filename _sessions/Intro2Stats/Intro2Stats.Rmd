...
- What population of data do I want to make inferences about?
- What does my sample represent?

## Random sampling

- Statistics allows you to make inferences to a population you have randomly sampled from.
...
#images of samples vs. populations
...
Our <high>p-value</high>, indicating the <high>likelihood of obtaining the data if the null hypothesis is true</high>, was (only) 0.0273.

The data are very unlikely if the mean amount poured is really 33dl.
