...
We rarely access to entire populations (when we do, we don't need to do statistics!)

We must use <high>sampling procedures</high> to a smaller <high>sample</high> of cases.
