...
<ul>
  ...
  <ul class=level>
    <li><span><high>Unterscheidet</high> sich ein deskriptives Mass <high>von angenommenen Werten</high>, z.B., zum Beispiel 0.</span></li>
...
<ul>
  <li class="m1"><span>Die X<sup>2</sup> Teststatistik summiert die <high>normalisierten, quadratischen Abweichungen</high> vom der auf Basis von <mono><b>p</b></mono> erwarteten Häufigkeiten.</span></li>
</ul>
