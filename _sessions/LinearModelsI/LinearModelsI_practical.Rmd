...
1. Create an object called `all_glm` which predicts price based on *all* variables in the `hitters` dataframe. Assign the result to an object called `all_glm`.Use the following guide to help you:
