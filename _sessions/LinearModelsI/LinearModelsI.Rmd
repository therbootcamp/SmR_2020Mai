...
<ul>
  <li class="m1"><span>Die <high>meisten inferenzstatitischen Tests</high> gehören zur Klasse der linearen Modelle.</span></li>
...
<ul>
  ...
  <ul class="level">
    ...
    <li><span>&beta;<sub>0</sub>: <high>Slope</high> oder Steigung</span></li>
  </ul>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Die Schätzung basiert auf dem auf dem <high>Kleinsten-Quadrate Kriterium</high>.</span></li>
  </ul>
</ul>
...
$$\Large \hat{y} = b_0 + b_1  \cdot x_1 + ... b_k \cdot b_k$$
...
<ul>
  <li class="m1"><span>Die Schätzung basiert auf dem auf dem <high>Kleinsten-Quadrate Kriterium</high>.</span></li>
  </ul>
</ul>
...
<ul>
  <li class="m1"><span>The beta weights follow a <high>t-Verteilung</high>.</span></li>
...
text(qt(.95,10)-.7,.025,labels=expression(alpha/2))
...
<h1><a href="https://therbootcamp.github.io/SmR_2020Apr/_sessions/LinearModelsI/LinearModelsI_practical.html">Practical</a></h1>
