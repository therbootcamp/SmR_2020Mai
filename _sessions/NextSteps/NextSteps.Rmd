...
<img src="https://therbootcamp.github.io/SwR_2020Apr/_sessions/Welcome/image/schedule.png" height="580" align="center">
]
...
<font style="font-size:28px"><i>...in the narrow sense</i></font><br>

| Package| Description| 
|:------|:------------|
| [`ggplot2`](https://cran.r-project.org/web/packages/caret/index.html) | Amazing package for plotting.  |
| [`dplyr`](https://cran.r-project.org/web/packages/mlr/index.html) | Amazing package for data wrangling | 
| [`tidyr`](https://cran.r-project.org/web/packages/e1071/index.html) | Helper functions to get your data tidy  |
| [`readr`](https://cran.r-project.org/web/packages/randomForest/index.html) | Powerful package for reading in data.  |
| [`purrr`](https://cran.r-project.org/web/packages/rpart/index.html) | Package for functional programming in R. |
| [`tibble`](https://cran.r-project.org/web/packages/FFTrees/index.html) | Package providing the `tibble` class |
| [`stringr`](https://cran.r-project.org/web/packages/cluster/index.html) | Amazing package for string manipulation |
| [`forcats`](https://cran.r-project.org/web/packages/fastcluster/index.html) | Package to solve common problems with factors |
...
<font style="font-size:28px"><i>...in the broad sense</i></font><br>

<p align="center">
<img src="image/rstudio.jpg" height=380px></img>
</p>
]
...
.pull-right45[
<br>
<center><a href="https://forms.gle/aJ6jk9Tq6YcyCsSg6">Bootcamp Follow-up Survey Link</a></center>

<p align="center"><iframe src="https://forms.gle/aJ6jk9Tq6YcyCsSg6" width="430" height="500">Wird geladen...</iframe></p>
...
<high>Basel, May 11-12, 2019</high></a>
...
<a href = "https://advancedstudies.unibas.ch/studienangebot/kurs/r-for-data-science-208287">

<font style="font-size:26px;weight:700">R for Data Science</font><br>
<br>
<img src="image/data_science.png" height="260px" width="480px"></img><br>

<high>Basel, June 11-12, 2019</high><br><br><br>
</a>
