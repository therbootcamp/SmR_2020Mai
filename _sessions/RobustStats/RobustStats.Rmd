...
<br>
The <high>variance inflation factor</high> (VIF) indicates the amount of variance of each predictor explained by the other predictors. The literatre recommends retaining predictors with <high>VIF < 10</high> [(Stine, 1995)](https://therbootcamp.github.io/SwR_2019Apr/_sessions/RobustStats/literature/)
...
One classicrelying on the combinatorics of ranks is the Wilcoxon or Mann-Whitney U test. 
