...
<p align="center" width="100%">
  <img src="https://raw.githubusercontent.com/therbootcamp/SwR_2019Apr/master/src/img/baseball.png?token=AIFo1PlxSH9Z8b82MTUkkJ8pNUE7-Gbyks5cqIaSwA%3D%3D" alt="Trulli" style="width:100%">
  <br>
...
1. Create a simple and multiple linear regression model with `glm()`
2. Explore the outputs of regression model, including coefficients, confidence intervals, and p-values.
3. Explore the residuals and fitted values of a regression model.
4. Use a regression model to make predictions for new data
...
8. Using the `confint()` function, print 95% confidence interval(s) for the regression coefficient(s) in your `HmRun_glm` object. What do they mean?
