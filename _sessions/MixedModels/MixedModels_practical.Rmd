...
4. Compare the model output of B3 with the one you obtained in B1.
...
5. Using `summary()`, inspect the results of the mixed effects model.
...
14. Compare the results with those of the earlier models.
...
5. Perform an LRT using the `anova()` function, by entering both model outputs (`IO_mod`, and `RI_mod`) as arguments.
...
10. Print the `pb_mod` object and inspect the results. Are the results different from the other tests you've performed before?
