...
9. Now extract the random effects from `subj_RI_mod` using the `ranef()` function.
...
11. Compare the outputs of the fixed effects only model, of the by-subjects random intercepts model, and of the by-subjects random intercepts and slopes model. Do this by applying the `summary()` function to each of the objects. Did the coefficients change? Why not? What did change?
