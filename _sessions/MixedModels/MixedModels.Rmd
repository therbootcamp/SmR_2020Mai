...
.pull-left45[
With random effects, we can account for random variability in the data that comes from different sources that introduce dependency in the data. We are usually not interested in the concrete instantiation of a particular level.
...
<img src="image/RI_example.png" width="70%" style="display: block; margin: auto;" />

<img src="image/MEM_example.png" width="70%" style="display: block; margin: auto;" />
...
But specifying the random effects structure when it is not apparent in the data can be overconservative. We will use a compromise and run a <high>backwards selection procedure</high> (see [Matuschek, Kliegl, Vasishth, Baayen, & Bates](https://www.sciencedirect.com/science/article/pii/S0749596X17300013)).
